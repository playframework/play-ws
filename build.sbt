...
lazy val mimaSettings = mimaDefaultSettings ++ Seq(
  ...
  mimaBinaryIssueFilters ++= Seq(
    ...
    ProblemFilters.exclude[IncompatibleSignatureProblem]("play.api.libs.ws.ahc.cache.AhcHttpCache.calculateTimeToLive"),
    ProblemFilters.exclude[IncompatibleSignatureProblem]("play.api.libs.ws.ahc.cache.AhcHttpCache.calculateFreshnessFromHeuristic"),
    ...
    ProblemFilters.exclude[IncompatibleSignatureProblem]("play.api.libs.ws.ahc.cache.ResponseEntry.unapply"),
    ProblemFilters.exclude[IncompatibleSignatureProblem]("play.api.libs.ws.ahc.cache.ResponseEntry.curried"),
    ProblemFilters.exclude[IncompatibleSignatureProblem]("play.api.libs.ws.ahc.cache.ResponseEntry.expiresAt"),
    ProblemFilters.exclude[IncompatibleSignatureProblem]("play.api.libs.ws.ahc.cache.ResponseEntry.tupled"),
    ProblemFilters.exclude[IncompatibleSignatureProblem]("play.api.libs.ws.ahc.cache.ResponseEntry.copy"),
    ProblemFilters.exclude[IncompatibleSignatureProblem]("play.api.libs.ws.ahc.cache.ResponseEntry.apply"),
    ProblemFilters.exclude[IncompatibleSignatureProblem]("play.api.libs.ws.ahc.cache.ResponseEntry.copy$default$4"),
    ProblemFilters.exclude[IncompatibleSignatureProblem]("play.api.libs.ws.ahc.cache.ResponseEntry.this"),
    ProblemFilters.exclude[IncompatibleSignatureProblem]("play.api.libs.ws.ahc.cache.ResponseEntry.unapply"),
    ProblemFilters.exclude[IncompatibleSignatureProblem]("play.api.libs.ws.ahc.cache.ResponseEntry.apply"),
  )
)
