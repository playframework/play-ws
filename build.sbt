...
lazy val mimaSettings = Seq(
  ...
  mimaBinaryIssueFilters ++= Seq(
    ...
    ProblemFilters.exclude[IncompatibleResultTypeProblem]("play.api.libs.ws.InMemoryBody._1"),
    ProblemFilters.exclude[IncompatibleResultTypeProblem]("play.api.libs.ws.SourceBody._1"),
  )
)
