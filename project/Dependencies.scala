...
object Dependencies {
  ...
  val logback = Seq("ch.qos.logback" % "logback-core" % "1.5.38")
  ...
  val nettyVersion    = "4.1.136.Final" // Keep in sync with the netty version netty-reactive-streams uses (see below)
